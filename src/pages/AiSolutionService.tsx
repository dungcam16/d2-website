        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: TrendingUp, value: "25%", label: "Sales Conversion", desc: "Through personalized recommendations" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { icon: TrendingUp, value: "180%", label: "Average ROI", desc: "Within 12 months" },
              ...
              {[
                {
                  ...
                  example: "Customer: 'I forgot my password' → Bot: instantly sends reset link + verifies identity"
                },
                {
                  icon: Target,
                  ...
                  example: "User views 'Enterprise Plan' → System recommends 'API Add-on' (25% conversion lift)"
                },
                {
                  icon: Shield,
                  ...
                  example: "Payment gateway latency spikes → Alert sent to engineering within 60 seconds"
                },
                {
                  icon: Globe,
                  ...
                  example: "Customer asked about billing last week → Bot remembers, references conversation"
                },
                {
                  icon: BarChart3,
                ...
                },
                {
                  ...
                  example: "Complex refund request → Bot gathers details, escalates with summary"
                },
              ].map((feature, index) => {
            ...
            {[
              {
                ...
                impacts: [
                  ...
                  "Response time: 4-8 hours → <5 minutes",
                  "CSAT improved: 3.2/5 → 4.7/5"
                ]
              },
              {
                title: "Sales & Revenue",
      ...
      <section className="py-16 bg-secondary/10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {[
              { icon: Award, stat: "10+", label: "AI projects delivered" },
              { icon: Star, stat: "4.8/5", label: "Client satisfaction" },
              { icon: Brain, stat: "Google Gemini", label: "AI Partner" },
              { icon: BarChart3, stat: "180%", label: "Average ROI" },
            ].map((item, index) => {
              const IconComponent = item.icon;
              return (
